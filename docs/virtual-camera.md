...
_(Screenshot placeholder: Discord Voice & Video settings showing OBS Virtual Camera selected)_
...
_(Screenshot placeholder: Webex camera picker showing OBS Virtual Camera)_
