...
export default function Onboarding({ onReady }) {
  ...
  function handleRecordingReady(blob, metaOrDuration = 0) {
    setRecording(blob);
    if (metaOrDuration && typeof metaOrDuration === "object") {
      setRecordingDuration(metaOrDuration.duration || 0);
    } else {
      setRecordingDuration(metaOrDuration || 0);
    }
  }
